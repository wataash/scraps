"""
MUJI 木製ベッドフレーム オーク材突板 シングル (商品番号 12892144) + 木製脚 12cm
https://www.muji.com/jp/ja/store/cmdty/detail/4550512892144

仕様シートより:
  外寸 1030(W) × 2020(D) × 55(H) mm (フレーム単体)
  長手フレーム 2020×70×55 × 2
  短手フレーム  890×70×55 × 2
  ウッドスプリング 5本 552×887 ×2枚 + 6本 704×887 ×1枚 (計16本のスラット)
