...
class yt0(CLI.Cmd):
    ...
    def add_parser(cls):
        ...
        subparser.add_argument('--client_secret_json', metavar='PATH', default='/tmp/yt0.cs.json', help='_')
        subparser.add_argument('--token_json', metavar='PATH', default='/tmp/yt0.token.json', help='_')
    ...
    def main(args: 'yt0.Args') -> None:
        ...
        if not os.path.exists(args.token_json):
            ...
            # ブラウザで
            # https://accounts.google.com/o/oauth2/auth/oauthchooseaccount?response_type=code&client_id=262673336981-orgquutqpmsi1lildkv0gdkg5dubqr1q.apps.googleusercontent.com&redirect_uri=http%3A%2F%2Flocalhost%3A34669%2F&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.force-ssl&state=zFVl01RuYTlKNXhxDVH6bsYSc5ADWp&access_type=offline&service=lso&o2v=1&flowName=GeneralOAuthFlow
            # が開かれる; 同意 →
            # http://localhost:39261/?state=UTSs0ihefADcKvbUVED1GtKZ2uOkJI&code=4/0AUJR-x4d_AJpdQ_Z4nkSRR7gqQUbHLhX41FRglL1xeQ7gwu0q88_kf5uwlS2ST6hrTEwxg&scope=https://www.googleapis.com/auth/youtube.force-ssl
            # > The authentication flow has completed. You may close this window.
            # これが出てから関数 return するのに1分くらいかかった
